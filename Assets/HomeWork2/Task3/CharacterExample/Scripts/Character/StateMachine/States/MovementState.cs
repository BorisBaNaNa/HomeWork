...
public abstract class MovementState : IStateTSK3
{
    protected readonly IStateSwitcherTSK3 StateSwitcher;
    protected readonly StateMachineData Data;

    private readonly CharacterTSK3 _character;

    public MovementState(IStateSwitcherTSK3 stateSwitcher, StateMachineData data, CharacterTSK3 character)
    {
    ...
    protected bool IsHorizontalInputZero() => Mathf.Approximately(Data.XInput,0);
